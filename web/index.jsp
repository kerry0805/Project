...
<html class="no-js" lang="vi">
    ...
    <body>
        ...
        <div class="slider_area slider_style home_three_slider owl-carousel">
            <div class="single_slider" data-bgimg="assets/img/slider/iphone.webp">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-12">
                            <div class="slider_content content_one">
                                <img src="assets/img/slider/IPhone-Logo.wine.png" alt="">
                                <p style="color: black">phone</p>
                                <a href="product" style="color: black">Discover Now</a>
                            </div>    
                        </div>
                    </div>
                </div>    
            </div>
            <div class="single_slider" data-bgimg="assets/img/slider/samsung.jpg">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-12">
                            <div class="slider_content content_two">
                                <img src="assets/img/slider/Samsung_Galaxy_logo.svg" alt="">
                                <p>phone</p>
            ...
            <div class="single_slider" data-bgimg="assets/img/slider/sony.jpg">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-12">
                            <div class="slider_content content_three">
                                <img src="assets/img/slider/Sony_logo.svg" alt="">
                                <p>phone</p>
                                <a href="product">Discover Now</a>
                            </div>    
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="banner_area">
                            <div class="banner_thumb">
                                <a href="product"><img src="assets/img/bg/s25u.jpg" alt="#"></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="banner_area">
                            <div class="banner_thumb">
                                <a href="product"><img src="assets/img/bg/16prm.jpg" alt="#"></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="banner_area bottom">
                            <div class="banner_thumb">
                                <a href="product"><img src="assets/img/bg/sonybanner.webp" alt="#"></a>
                            </div>
                        </div>
                    </div>
                </div>
