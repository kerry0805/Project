...
public class productDAO {
    ...
    public List<Memory> getSize() {
        ...
        try {
            ...
            rs = ps.executeQuery();
            while (rs.next()) {
                list.add(new Memory(rs.getString(1), rs.getString(2)));
            }
        } catch (Exception e) {
        }
        return list;
    ...
    public List<Memory> getSizeByID(String product_id) {
        List<Memory> list = new ArrayList<>();
